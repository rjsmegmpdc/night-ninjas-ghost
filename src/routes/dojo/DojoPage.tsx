  ...
  return (
    <div className={['border p-6 space-y-4 transition-colors', isSelected ? 'border-accent bg-accent/5' : 'border-ink-line bg-ink-shadow hover:border-ink-line-bold'].join(' ')}>
      ...
      <button
        ...
        className={['flex items-center gap-2 font-mono text-xs uppercase tracking-widest px-4 py-2 border transition-colors', isSelected ? 'border-accent text-accent bg-accent/10 cursor-default' : 'border-ink-line text-bone-dim hover:border-accent hover:text-accent'].join(' ')}
      >
      ...
      <div className="flex items-center gap-0 flex-wrap divide-x divide-ink-line">
        ...
        <div className="px-5 py-4 ml-auto">
          <button
            ...
            className="font-mono text-[10px] uppercase tracking-widest text-bone-mute hover:text-accent border border-ink-line hover:border-accent px-3 py-2 transition-colors"
          >
            Change plan
          </button>
        </div>
...
function TrainingCalendar({
  ...
  return (
    <section aria-label="Training calendar">
      ...
      <div className="border border-ink-line p-4 mb-6 space-y-3">
      ...
      <div className="space-y-6">
        {months.map(month => (
          <div key={month.key}>
            ...
            <div className="border border-ink-line divide-y divide-ink-line overflow-x-auto">
      ...
      {showPicker && (
        <section aria-labelledby="dojo-picker-heading">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
            ...
            {/* Level toggle */}
            <div className="flex border border-ink-line" role="group" aria-label="Training level">
